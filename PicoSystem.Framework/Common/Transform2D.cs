...
namespace PicoSystem.Framework.Common
{
    ...
    public struct Transform2D : IEquatable<Transform2D>
    {
        ...
        private static readonly Transform2D _identity;
        ...
        public bool IsEmpty => M11 == 1 && M22 == 1 && TX == 0 && TY == 0 && M12 == 0 && M21 == 0;
        ...
        static Transform2D()
        {
            Transform2D.CreateEmpty(out _identity);
        }
        ...
        /// </summary>
        /// <returns>Identity transform</returns>
        ...
        {
            Transform2D temp;
            Vector2 factor = new Vector2(scaleFactor, scaleFactor);
        ...
        /// Creates the translation transform.
        /// </summary>
        /// <param name="translation">Input translation Vector2</param>
        /// <param name="result">The result transform.</param>
        ...
        /// <returns>
        /// true if the current transform is equal to the <param ref="other"/>; otherwise, false.
        /// </returns>
