...
namespace PicoSystem.Framework.GameToolkit.Animation
{
    public class Tween
    {
        ...
        private readonly List<EaseTargetInfo> vars;
        ...
        public Tween From(object values)
        {
            ...
            foreach (var property in props)
            {
                ...
                var easeTargetInfo = new EaseTargetInfo(Target, property.Name) {Value = propValue};
            }
        ...
        /// </summary>
        /// <param name="easeFunc">The Easer to use.</param>
        /// <returns>A reference to this.</returns>
        public Tween Ease(Func<float, float> easeFunc)
        {
            this.ease = easeFunc;
            return this;
        }
        ...
        public void Cancel(params string[] properties)
        {
            ...
            foreach (string t in properties)
            {
                ...
                if (!varHash.TryGetValue(t, out index))
                {
                    continue;
                }
