...
namespace PicoSystem.Framework.GameToolkit.Animation
{
    public class Tweener
    {
        ...
        private static void SetLerper<TLerper>(Type propertyType) where TLerper : Lerper, new()
        {
        ...
        /// <param name="propertyType">The type of the property to associate the given Lerper with.</param>
        private static void SetLerper(Type lerperType, Type propertyType)
        {
        ...
        public void TargetCancel(object target)
        {
            ...
            if (!tweens.TryGetValue(target, out list)) return;
